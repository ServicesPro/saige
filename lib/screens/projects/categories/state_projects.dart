...
class StateProjects extends StatefulWidget {
  @override
  _StateProjectsState createState() => _StateProjectsState();
}

class _StateProjectsState extends State<StateProjects> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0.0,
        backgroundColor: theme.primaryColor,
        title: Text("Projets d'" + "é".toUpperCase() + "tat"),
        actions: <Widget>[
          FlatButton.icon(
            onPressed: () async {
              await _auth.signOut();
